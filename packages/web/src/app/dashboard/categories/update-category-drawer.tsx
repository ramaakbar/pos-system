...
import type { Category } from "api/src/db/schema/categories";
...
export const UpdateCategoryDrawer = ({
  ...
  const { mutate, isPending } = useMutation<
    unknown,
    DefaultError,
    InferRequestType<(typeof client.categories)[":id"]["$patch"]>["json"]
  >({
    mutationFn: async (values) => {
      const res = await client.categories[":id"].$patch({
        param: {
          id: category.id,
        },
        json: values,
